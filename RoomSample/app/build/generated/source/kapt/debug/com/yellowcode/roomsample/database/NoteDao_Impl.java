...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNote = new EntityInsertionAdapter<Note>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `note_table`(`id`,`title`,`content`) VALUES (nullif(?, 0),?,?)";
      }
  ...
  public Object findNoteByTitle(final String title, final Continuation<? super Note> p1) {
    final String _sql = "SELECT * FROM note_table WHERE title LIKE ?";
      ...
      public Note call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final String _tmpContent;
            _tmpContent = _cursor.getString(_cursorIndexOfContent);
            _result = new Note(_tmpId,_tmpTitle,_tmpContent);
          } else {
            _result = null;
          }
          return _result;
